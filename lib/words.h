...
// Função para salvar palavras reservadas e identificadores
...
// Função para validar a palavra reservada AND
...
// Função para validar palavra reservada WRITED
...
// Função para validar palavra reservada WRITEC
...
// Função para validar palavra reservada
...
int is_less_than_equal(char * input_word, int size_word, int line_count) {
    ...
    for (i = 0; i < size_word; i++) {
        ...
        // Valida se não é um caractere especial
...
// Função para listar palavras reservadas
...
// Verificação de função e criação de arquivo de saída
...
// Função para verificar e validar palavras identificadas
...
// Função para validar os caracteres de terminação mais comuns e verificar SPECIAL_WORD
...
// Função para concatar novos caracteres em WORD
...
// Função para validar caracteres reservados SPECIAL_WORD
